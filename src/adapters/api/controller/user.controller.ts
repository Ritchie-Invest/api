...
import { MarkBadgeSeenMapper } from '../mapper/mark-badge-seen.mapper';
...
export class UserController {
  ...
  async markBadgeSeen(
    ...
    const command = MarkBadgeSeenMapper.toDomain(currentUser, body);
    await this.markBadgeSeenUseCase.execute(command);
    return { status: 'ok' };
  }
}
